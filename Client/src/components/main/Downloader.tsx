...
function Downloader() {
  return (
    <>
      ...
      <main className="box-holder max-w-[350px] md:max-w-[600px] lg:max-w-[900px] py-10 duration-200 flex flex-col gap-3">
        <div className="flex flex-col md:flex md:flex-row gap-4">
          <input
            className="border-none outline-none placeholder:text-slate-700 w-[300px] bg-300 py-2 px-4 rounded-full ring-0 focus:ring-2 ring-100 duration-200"
            type="sreach"
        ...
        <div>
          <div className="bg-300 w-[300px] md:w-[450px] flex items-center rounded-lg justify-center py-4 px-4">
